  ...
  units: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          heading: 'Letter Map (1-11)',
          text: 'Aleph = א, Bet = ב, Gimel = ג, Dalet = ד, He = ה, Vav = ו, Zayin = ז, Het = ח, Tet = ט, Yod = י, Kaf = כ/ך.'
        },
        {
          heading: 'Letter Map (12-22)',
          text: 'Lamed = ל, Mem = מ/ם, Nun = נ/ן, Samekh = ס, Ayin = ע, Pe = פ/ף, Tsadi = צ/ץ, Qof = ק, Resh = ר, Shin = ש, Tav = ת.'
        },
        {
        ...
        {
          heading: 'Transliteration Practice',
          text: 'Practice transliterating: אב (ab), בר (br), לב (lb), מלך (mlk), ספר (spr). Focus on matching letter names to sounds.'
        },
        {
          heading: 'Practice: Multiple Choice',
          text: '1) Which square Hebrew letter corresponds to Paleo-Hebrew Aleph? A) א B) ב C) ג D) ד\n\n2) Which corresponds to Tsadi? A) צ B) ס C) ש D) ת\n\n3) Which corresponds to Qof? A) ק B) כ C) ג D) פ\n\n4) Which corresponds to Shin? A) ש B) ס C) צ D) ק\n\nAnswers: 1-A, 2-A, 3-A, 4-A'
        },
        {
          heading: 'Practice: Matching',
          text: 'Match letter name to square Hebrew:\n\n1) Bet 2) Gimel 3) Dalet 4) He 5) Vav\n\nA) ה B) ב C) ו D) ג E) ד\n\nAnswers: 1-B, 2-D, 3-E, 4-A, 5-C'
        },
        {
          heading: 'Reading Sequence',
          text: 'Short transliterations:\n\nab - father\nbr - son\nlb - heart'
        },
      ],
      keyTerms: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          heading: 'Practice: Multiple Choice',
          text: '1) Ostraca are: A) Pottery shards used for writing B) Stone tablets C) Metal coins only D) Paper manuscripts\n\n2) Seals were used for: A) Identification B) Pronunciation C) Translation only D) Vowel marking\n\n3) Reading inscriptions begins with: A) Letter identification B) Translation only C) Grammar tables D) Skipping unknown letters\n\nAnswers: 1-A, 2-A, 3-A'
        },
        {
          heading: 'Practice: Matching',
          text: 'Match term to meaning:\n\n1) Ostraca 2) Seal 3) Context\n\nA) Historical setting guiding interpretation B) Stamped inscription used for identification C) Pottery shards used for writing\n\nAnswers: 1-C, 2-B, 3-A'
        },
        {
          heading: 'Reading Snippets',
          text: 'Short inscriptions:\n\nלמלך — lmlk — belonging to the king\nבר — br — son'
        },
      ],
      keyTerms: [
        ...
        {
          heading: 'Reading Sequence',
          text: 'Inscriptions:\n\nseal - lmlk (belonging to the king)\nostraca - bn (son)'
        },
    ...
    },
    {
      ...
      content: [
        ...
        {
          heading: 'Practice: Multiple Choice',
          text: '1) Paleo-Hebrew texts often include: A) Names and titles B) Long vowels only C) Modern slang D) Only poetry\n\n2) Without vowel points, meaning relies on: A) Context and consonantal patterns B) Random guessing C) Only punctuation D) Only word order\n\n3) Proper names are: A) Personal or place names B) Verb forms C) Particles D) Prepositions\n\nAnswers: 1-A, 2-A, 3-A'
        },
        {
          heading: 'Practice: Matching',
          text: 'Match term to meaning:\n\n1) Proper name 2) Pattern recognition 3) Consonantal pattern\n\nA) Word shape based on consonant sequence B) Personal or place name C) Identifying common word shapes\n\nAnswers: 1-B, 2-C, 3-A'
        },
        {
          heading: 'Reading Snippets',
          text: 'Names/titles:\n\nדוד — dwd — David\nנחם — nhm — Nahum'
    ...
    },
    {
      ...
      content: [
        ...
        {
          heading: 'Practice: Multiple Choice',
          text: '1) Recognizing roots helps: A) Interpret short forms B) Only pronunciation C) Only syntax D) Only punctuation\n\n2) Inscriptions are often: A) Short and fragmentary B) Long narratives C) Only poetry D) Only legal codes\n\n3) Context is important because it: A) Guides meaning B) Eliminates meaning C) Replaces grammar D) Removes vocabulary\n\nAnswers: 1-A, 2-A, 3-A'
        },
        {
          heading: 'Practice: Matching',
          text: 'Match term to meaning:\n\n1) Root 2) Context 3) Short form\n\nA) Brief verbal or nominal form B) Surrounding information guiding interpretation C) Core consonants of a Hebrew word\n\nAnswers: 1-C, 2-B, 3-A'
        },
        {
          heading: 'Reading Snippets',
          text: 'Root samples:\n\nכתב — ktb — write\nאמר — amr — say'
    ...
    },
    {
      ...
      content: [
        ...
        {
          heading: 'Practice: Multiple Choice',
          text: '1) Transliteration is: A) Representing letters in another script B) Translation of meaning C) Pronunciation only D) Grammar only\n\n2) Practice sets improve: A) Recognition B) Only pronunciation C) Only syntax D) Only history\n\n3) Reading practice should use: A) Short phrases B) Long narratives only C) Only poetry D) Only grammar tables\n\nAnswers: 1-A, 2-A, 3-A'
        },
        {
          heading: 'Practice: Matching',
          text: 'Match term to meaning:\n\n1) Transliteration 2) Practice set 3) Recognition\n\nA) Ability to identify letters quickly B) Collection of sample readings C) Representing letters in another script\n\nAnswers: 1-C, 2-B, 3-A'
        },
        {
          heading: 'Reading Snippets',
          text: 'Short phrases:\n\nבן מלך — bn mlk — son of the king\nבית יה — byt yh — house of Yah'
        },
      ],
      keyTerms: [
        { term: 'Transliteration', definition: 'Representing letters in another script' },

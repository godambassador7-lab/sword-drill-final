  ...
  units: [
    {
      ...
      letters: [
        ...
        { char: 'ב', name: 'Bet', transliteration: 'b/v', sound: 'b (with dagesh), v (without)' },
        ...
        { char: 'ח', name: 'Het', transliteration: 'ḥ', sound: 'kh (like ch in Bach)' },
        { char: 'ט', name: 'Tet', transliteration: 'ṭ', sound: 'emphatic t' },
        { char: 'י', name: 'Yod', transliteration: 'y', sound: 'y as in yes' },
        { char: 'כ', name: 'Kaf', transliteration: 'k/kh', sound: 'k (with dagesh), kh (without)', finalForm: 'ך' },
        ...
        { char: 'פ', name: 'Pe', transliteration: 'p/f', sound: 'p (with dagesh), f (without)', finalForm: 'ף' },
        ...
        { char: 'ש', name: 'Shin', transliteration: 'š/s', sound: 'sh (Shin) or s (Sin)' },

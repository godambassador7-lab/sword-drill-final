...

    {
      ...
      content: [
...

        {
          ...
          text: 'Series order is consistent: 1=ae, 2=u, 3=i, 4=ah, 5=e, 6=uh (schwa), 7=o. Memorize the order and apply it to each consonant family.'
...

        {
          ...
          text: '1) Amharic uses: A) An abugida B) An alphabet only C) A syllabary only D) Pictographs\n\n2) Series order #4 is: A) ah B) ae C) i D) o\n\n3) Series order #6 is: A) uh (schwa) B) u C) e D) i\n\n4) Each fidel character represents: A) A syllable B) A word C) A phrase D) A sentence\n\nAnswers: 1-A, 2-A, 3-A, 4-A'
...

        {
          ...
          heading: 'Canonical Graded Reading (Amharic NT)',
...

        {
          ...
          heading: 'Canonical Short Reading (Amharic NT)',
...

    {
      ...
      content: [
...

        {
          ...
          text: 'Match term to meaning:\n\n1) Syllable 2) Phonology 3) Series\n\nA) Sound system B) Unit of pronunciation represented by a fidel character C) Vowel variations within a consonant set\n\nAnswers: 1-B, 2-A, 3-C'
...

    {
      ...
      content: [
...

        {
          ...
          text: '1) Amharic nouns mark: A) Gender and number B) Only tense C) Only aspect D) Only case\n\n2) Plurals are often formed with: A) Suffixes or patterns B) Only prefixes C) Only vowel change D) No change\n\n3) Definiteness indicates: A) A specific noun B) Only a verb C) Only a preposition D) Only a particle\n\nAnswers: 1-A, 2-A, 3-A'
...

        {
          ...
          text: 'Match term to meaning:\n\n1) Gender 2) Plural 3) Definite\n\nA) Specific noun marker B) Masculine/feminine noun classes C) More than one\n\nAnswers: 1-B, 2-C, 3-A'
...

    {
      ...
      content: [
...

        {
          ...
          text: 'Romanized roots:\n\nktb â write\nsbr â break/hope (context)\nmlk â reign'
...

    {
      ...
      content: [
...

        {
          ...
          text: '1) Amharic commonly uses: A) SOV word order B) SVO only C) VSO only D) No word order\n\n2) Particles help with: A) Word relationships B) Only pronunciation C) Only spelling D) Only vocabulary\n\n3) Word order can vary for: A) Emphasis B) Randomness C) Only vowels D) Only punctuation\n\nAnswers: 1-A, 2-A, 3-A'
...

        {
          ...
          text: 'Match term to meaning:\n\n1) SOV 2) Particle 3) Clause\n\nA) Unit with a verb and complements B) Subject-Object-Verb word order C) Small word with grammatical function\n\nAnswers: 1-B, 2-C, 3-A'
...

    {
      ...
      content: [
...

        {
          ...
          text: '1) Reading practice should start with: A) Short sentences B) Long paragraphs C) Only poetry D) Only grammar tables\n\n2) Parsing helps with: A) Identifying forms B) Only pronunciation C) Only spelling D) Only history\n\n3) Translation should consider: A) Context and grammar B) Only word order C) Only vocabulary D) Only punctuation\n\nAnswers: 1-A, 2-A, 3-A'
...

        {
          ...
          text: 'Match term to meaning:\n\n1) Vocabulary 2) Parsing 3) Context\n\nA) Surrounding text shaping meaning B) Identifying grammatical forms C) Common word stock for reading\n\nAnswers: 1-C, 2-B, 3-A'

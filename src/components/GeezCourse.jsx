...
const GeezCourse = ({ onComplete, onCancel, userId, userData, setUserData }) => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-teal-900 to-red-900 flex items-center justify-center">
        <div className="text-indigo-400 text-xl">Loading ግዕዝ Ge'ez Course...</div>
      </div>
    );
  }
  ...
  if (showExam) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-teal-900 to-red-900 p-4 flex items-center justify-center">
  ...
  if (selectedLevel) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-teal-900 to-red-900 p-4 pb-24">
        <div className="max-w-4xl mx-auto">
          <div className="bg-slate-800 rounded-2xl p-4 sm:p-6 md:p-8 border-2 border-indigo-500">
            ...
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-indigo-400 mb-2">{levelData.title}</h2>
              <p className="text-slate-300">Classical Ethiopic - Language of ancient scripture</p>
            </div>

            <div className="bg-slate-700/50 rounded-xl p-6 mb-6">
              <h3 className="text-xl font-bold text-indigo-300 mb-4">Lesson {currentLessonIndex + 1}</h3>
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full bg-gradient-to-r from-indigo-600 to-teal-600 text-white font-bold py-4 px-6 rounded-xl hover:from-indigo-500 hover:to-teal-500 transition-all flex items-center justify-center gap-2"
              >
                <CheckCircle size={20} />
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center gap-3 mb-4">
            <Scroll className="text-indigo-400" size={48} />
            <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 to-teal-400">
              {courseData.title}
            </h1>
          </div>
            ...
            return (
              <div
                ...
                className={`rounded-2xl p-6 border-2 transition-all ${
                  isUnlocked
                    ? 'bg-gradient-to-br from-slate-800 to-slate-900 border-indigo-500 hover:border-indigo-400 cursor-pointer'
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-xl font-bold text-indigo-300">Level {index + 1}</h3>
                  </div>
                ...
                {isUnlocked && (
                  <div className="mt-4">
                    ...
                    <div className="text-xs text-indigo-400 mt-2">+100 points per lesson completed</div>
                  </div>
                )}
                ...
                {isUnlocked && (
                  <button className="mt-4 w-full bg-gradient-to-r from-indigo-600 to-teal-600 text-white font-semibold py-2 px-4 rounded-lg hover:from-indigo-500 hover:to-teal-500 transition-all flex items-center justify-center gap-2">
        ...
        <div className="mt-8 bg-slate-800/50 rounded-xl p-6 border border-indigo-700/30">
          <h3 className="text-indigo-400 font-bold text-lg mb-3 flex items-center gap-2">

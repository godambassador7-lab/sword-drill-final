...
const TextualCriticismQuiz = ({ questions, moduleTitle, isExam = false, onComplete, onRetry, onOpenBibleReader }) => {
          ...
          <div className="bg-slate-800 rounded-2xl p-8 border-2 border-purple-500">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-purple-300">
                {isExam ? 'Final Exam' : 'Module Quiz'} Complete
              </p>
            </div>

            {/* Score Display */}
            <div className="bg-gradient-to-r from-purple-900 to-indigo-900 rounded-xl p-6 mb-6">
                ...
                {performance.passed ? (
                  <>
                    ...
                    <h3 className="text-2xl font-bold text-green-400">
                      {isExam ? 'Exam Passed!' : 'Module Passed!'}
                    </h3>
                  </>
                ) : (
                  <>
  ...
  const studyLens = buildStudyLens(question, 'textual-criticism');
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-2xl font-bold text-white">
                {moduleTitle} {isExam ? '- Final Exam' : '- Quiz'}
              </h2>
          ...
          <div className="bg-slate-900 rounded-xl p-6 mb-6">
            ...
            <div className="space-y-3">
              {question.options.map((option, index) => {
                ...
                let buttonStyle = 'bg-slate-800 border-2 border-slate-700 hover:border-purple-500 text-white';
                ...
                if (showResult) {
                  ...
                  buttonStyle = 'bg-purple-900/50 border-2 border-purple-500 text-white';
                }
          ...
          {showExplanation && (
            <div className={`rounded-xl p-6 mb-6 ${
                  ...
                  <div className="flex flex-wrap gap-2">
                    {studyLens.references.map((ref) => (
                      <button
                        ...
                        type="button"
                        onClick={() => openRef(ref)}
                        className="text-xs bg-purple-600/30 text-purple-200 px-2 py-1 rounded font-mono hover:bg-purple-500/40 transition-colors"
              ...
              <div className="mt-3 pt-3 border-t border-slate-600 text-sm space-y-2">
                <p className="text-purple-200 font-semibold">Study Method (Scholarly Lens)</p>
          ...
          <div className="flex justify-end">
            {!showExplanation ? (
              ...
              <button
                ...
                className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-bold py-3 px-8 rounded-xl transition-all flex items-center gap-2"
              >
...
export default TextualCriticismQuiz;
